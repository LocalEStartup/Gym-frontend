...
function Sidebar({ isOpen, toggleSidebar, menuItems, setHeaderTitle }) {
  ...
  return (
    <div
      className={`bg-yellow-400 text-white w-64 fixed lg:static z-50 transform ${
        isOpen ? "translate-x-0" : "-translate-x-full"
      } lg:translate-x-0 transition-transform duration-300 h-full shadow-lg`}
    >
      <div className="p-4 font-bold text-lg flex justify-between items-center border-b border-yellow-500">
